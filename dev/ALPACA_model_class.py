...
class Model:
    ...
    def add_event_count_variables(self):
        ...
        # each edge and each allele can have one change up or down. 
        # To reflect this we take the number of events (i.e. the magnitude of change) and binarize it to 0 and 1 states.
