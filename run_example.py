...
tumour_outputs = []
all_solutions = [] # do not store all solutions for segments or tumours, but for whole cohort
...
if SS.output_all_solutions:
    ...
    all_solutions.to_csv(f'{cohort_output_directory}/all_solutions_combined.csv', index=False)
print('Done')
print("""
