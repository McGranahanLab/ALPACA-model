...
def input_conversion():
    ...
    try:
        ...
        script_path = pkg_resources.resource_filename('alpaca', 'scripts/submodules/alpaca_input_formatting/input_conversion.sh')
        
        # Locate the submodules directory
        submodules_path = pkg_resources.resource_filename('alpaca', 'scripts/submodules')
