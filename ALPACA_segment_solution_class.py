...
class SegmentSolution:
    def __init__(self, input_file_name, config=None):
        ...
        self.ci_table = get_ci_table(self.input_table, self.tumour_dir, self.segment,ci_table_name=self.ci_table_name, CI=self.ci)
    ...
    def run_model(self, allowed_complexity):
        ...
        model_iteration.solution = missing_clones_inherit_from_children(model_iteration.solution, self.tree, self.cp_table) #TODO move this method to Model class
