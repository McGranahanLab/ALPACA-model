...
parser.add_argument('--prevent_increase_from_zero_flag', type=int, default=1,help='')
parser.add_argument('--add_event_count_constraints_flag', type=int, default=1,help='')
parser.add_argument('--add_state_change_count_constraints_flag', type=int, default=0,help='')
parser.add_argument('--add_path_variability_penalty_constraints_flag', type=int, default=0, help='')
parser.add_argument('--add_allow_only_one_non_directional_event_flag', type=int, default=1, help='')
parser.add_argument('--time_limit', default=60, type=int, help='Time limit in seconds for each model run')
parser.add_argument('--homozygous_deletion_threshold', type=float, default = 1, help='')
...
parser.add_argument('--ci_table_name', default='ci_table.csv', type=str, help='Name of file containing confidence intervals for SNP copynumbers')
