...
parser.add_argument(
    "--input_files", type=str, required=True, help="Input table for one segment."
)
...
parser.add_argument(
    "--add_allow_only_one_non_directional_event_flag", type=int, default=1, help=""
)
parser.add_argument(
    "--time_limit",
    default=60,
...
input_files = shlex.split(
    args.input_files
)  # each input file is a file name of a table containing single segment
